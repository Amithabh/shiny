...
(function() {
  ...
  Shiny.addCustomMessageHandler(
    'shiny-progress-open',
    function(data) {
      var num = $('.shiny-global-progress.open').length + 1;

      var $progress = $('<div class="shiny-global-progress open"><div class="progress-message"></div><div class="progress-detail"></div><div class="progress progress-striped active"><div class="bar"></div></div></div>');
  ...
  Shiny.addCustomMessageHandler(
    ...
    function(data) {
      var $progress = $('#' + data.id + '.shiny-global-progress');
