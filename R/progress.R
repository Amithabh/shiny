...
#'
#' Shiny exposes two distinct programming APIs for working with progress.
#' \code{\link{withProgress}} and \code{\link{setProgress}} together provide a
#' simple function-based interface, while the \code{Progress} reference class
